...
fun ProvideDisplayInsets(
    ...
    val displayInsets = remember {
        DisplayInsets().apply {
            ...
            systemBars.updateFrom(rootWindowInsets?.systemWindowInsets ?: androidx.core.graphics.Insets.NONE)
            systemGestures.updateFrom(rootWindowInsets?.systemGestureInsets ?: androidx.core.graphics.Insets.NONE)
        }
    }
